<template>
  <article class="container mx-auto">
    ...
    <ClientOnly>
      <div
        class="mx-auto mb-10 flex max-w-xl flex-col gap-2 bg-zinc-300/75 p-5 dark:bg-zinc-800/75"
      >
        <section
          v-for="(p, i) in list"
          :key="`news_${p.id}`"
...
const list = ref<{ body: string; id: number; title: string; userId: number }[]>([]);
